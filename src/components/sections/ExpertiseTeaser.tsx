    ...
    >
      ...
      <div className="relative z-10 space-y-12">
        <div className="text-center max-w-3xl mx-auto space-y-4">
          ...
          <div className="pt-2">
            <div className="inline-flex flex-wrap items-center justify-center gap-2 sm:gap-3 px-4 sm:px-6 py-2.5 rounded-full bg-white shadow-2xs text-xs sm:text-sm font-semibold text-navy-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
          {displayDomains.map((domain) => {
            ...
            return (
              <div
                key={domain.id}
                className="group relative bg-white rounded-3xl p-6 sm:p-8 border border-border-subtle shadow-card hover:shadow-card-hover hover:-translate-y-1 transition-all duration-300 ease-out flex flex-col justify-between"
              >
                <div className="space-y-5">
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex items-center gap-3.5">
                      <div className="w-12 h-12 rounded-xl bg-brandBlue-50 text-brandBlue-600 flex items-center justify-center group-hover:bg-brandBlue-600 group-hover:text-white transition-colors duration-150 shadow-xs">
                      ...
                      <div>
                        ...
                        <h3 className="text-lg sm:text-xl font-extrabold text-navy-900 group-hover:text-brandBlue-600 transition-colors duration-150">
                          {domain.title}
                        </h3>
                      </div>
                    </div>
                    <span className="shrink-0 text-[11px] font-bold text-navy-700 bg-surface-tint px-3 py-1 rounded-full">
                      {domain.badge}
                    </span>
                  </div>
                  ...
                  <div className="space-y-2 pt-2 border-t border-border-subtle">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                      {domain.topics.slice(0, 4).map((topic, topicIdx) => (
                        <div
                          key={topicIdx}
                          className="flex items-start gap-2 text-xs text-navy-800 bg-surface-tint/70 hover:bg-white p-2 rounded-xl transition-colors duration-150"
                        >
                ...
                <div className="mt-6 pt-4 border-t border-border-subtle flex items-center justify-between">
                  ...
                  <Link
                    to="/jaringan-ahli"
                    className="inline-flex items-center gap-1 text-xs sm:text-sm font-bold text-brandBlue-600 group-hover:text-brandBlue-700 group-hover:underline underline-offset-4 transition-all duration-150 ease-out"
                  >
                    <span>Detail Silabus</span>
                    <ArrowRight className="w-3.5 h-3.5 group-hover:translate-x-1 transition-transform duration-200 ease-out" aria-hidden="true" />
                  </Link>
                </div>
              </div>
            );
        ...
        <div className="text-center pt-2">
          <Link
            ...
            className="group inline-flex items-center justify-center gap-2.5 min-h-[50px] px-8 py-3.5 rounded-xl font-bold text-sm sm:text-base text-white bg-navy-900 hover:bg-navy-800 border border-navy-700 shadow-md hover:shadow-lg transition-all duration-150 ease-out focus:outline-none focus-visible:ring-2 focus-visible:ring-brandBlue-500 active:scale-[0.98]"
          >
            <span>Jelajahi Seluruh Direktori Ahli &amp; Silabus</span>
            <ArrowRight className="w-4 h-4 text-coral-400 group-hover:translate-x-1 transition-transform duration-200 ease-out" aria-hidden="true" />
          </Link>
        </div>
      </div>
    </SectionContainer>

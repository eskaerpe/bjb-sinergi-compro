    ...
    >
      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-10 items-center">
        <div className="lg:col-span-7 space-y-6 text-left">
          <div className="inline-flex items-center gap-2.5 px-4 py-1.5 rounded-full bg-white/[0.08] text-xs font-semibold text-white/95 backdrop-blur-md shadow-sm">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white tracking-tight leading-[1.18]">
            ...
            <span className="relative inline-block text-transparent bg-clip-text bg-gradient-to-r from-[#50A4CB] via-[#FEA959] to-[#FEB975]">
              ...
              <span
                className="absolute bottom-1 left-0 w-full h-2.5 bg-[#FEA959]/25 -z-10 rounded-full blur-[1px]"
                aria-hidden="true"
              />
            </span>
          </h1>
          ...
          <div className="pt-2 border-y border-white/15 py-4 my-2">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              <div className="flex items-center gap-3 p-3 rounded-2xl bg-white/[0.07] backdrop-blur-md">
                <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#0D4480] to-[#427B8E] text-[#50A4CB] flex items-center justify-center flex-shrink-0 shadow-xs">
              ...
              <div className="flex items-center gap-3 p-3 rounded-2xl bg-white/[0.07] backdrop-blur-md">
                <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#DA8629]/40 to-[#0D4480] text-[#FEA959] flex items-center justify-center flex-shrink-0 shadow-xs">
          ...
          <div className="pt-2 space-y-4">
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3.5">
              <Link
                ...
                className="inline-flex items-center justify-center gap-2.5 min-h-[48px] px-8 py-3.5 rounded-xl font-bold text-sm text-navy-950 bg-[#FEA959] hover:bg-[#FEB975] shadow-lg shadow-[#FEA959]/25 hover:shadow-[#FEA959]/40 transition-all duration-150 ease-out focus:outline-none focus-visible:ring-2 focus-visible:ring-[#FEA959] active:scale-[0.98] group"
              >
                <span>Jelajahi Seluruh Layanan</span>
                <ArrowRight className="w-4 h-4 text-navy-950 group-hover:translate-x-1 transition-transform duration-200 ease-out" aria-hidden="true" />
              </Link>
              <Link
                to="/kontak"
                aria-label="Minta penawaran atau proposal program"
                className="inline-flex items-center justify-center gap-2 min-h-[48px] px-6 py-3.5 rounded-xl font-bold text-sm text-white bg-white/10 hover:bg-white/15 border border-white/20 backdrop-blur-md shadow-sm transition-all duration-150 ease-out focus:outline-none focus-visible:ring-2 focus-visible:ring-white active:scale-[0.98]"
              >
            ...
            <div className="flex items-center gap-2 pt-1 text-xs text-slate-300">
              ...
              <a
                ...
                className="inline-flex items-center gap-1.5 font-semibold text-slate-300 hover:text-white hover:underline transition-colors duration-150 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#FEA959] rounded-xl"
              >
        ...
        <div className="lg:col-span-5">
          <div className="relative">
              ...
              {SPOTLIGHT_ITEMS.map((item) => {
                ...
                return (
                  <button
                    ...
                    className={`flex-1 min-h-[44px] px-3 py-2 rounded-xl text-xs font-bold transition-all duration-150 ease-out whitespace-nowrap focus:outline-none focus-visible:ring-2 focus-visible:ring-[#FEA959] ${
                      isActive
            ...
            <div
              ...
              role="tabpanel"
              className="relative rounded-3xl overflow-hidden border border-white/20 shadow-2xl bg-navy-950/90 group backdrop-blur-sm"
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-[#08285D] via-[#08285D]/40 to-transparent pointer-events-none" />

              <div className="absolute top-4 left-4">
                <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold text-white bg-[#08285D]/90 backdrop-blur-md shadow-lg">
